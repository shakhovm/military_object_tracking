...
def run(settings):
    ...
    my_dataset_train = MyDataset(settings.env.my_dataset_dir)

    my_dataset_val = MyDataset(settings.env.my_dataset_dir, split='val')
    ...
    # The sampler for training
    sampler_per_epoch_train = 20*settings.batch_size
    dataset_train = sampler.ATOMSampler([my_dataset_train], [1],
                                samples_per_epoch=sampler_per_epoch_train, max_gap=50, processing=data_processing_train)
    ...
    sampler_per_epoch_val = 10 * settings.batch_size
    dataset_val = sampler.ATOMSampler([my_dataset_val], [1], samples_per_epoch=sampler_per_epoch_val, max_gap=50,
                                      processing=data_processing_val)
