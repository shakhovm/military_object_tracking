...
def run(settings):
    ...
    settings.train_samples_per_epoch = 1000
    settings.val_samples_per_epoch = 500
    ...
    my_dataset_train = MyDataset(root=settings.env.my_dataset_dir, split='train')

    my_dataset_val = MyDataset(root=settings.env.my_dataset_dir, split='val')
    # Data transform
    ...
    dataset_train = sampler.DiMPSampler([my_dataset_train], [1],
    ...
    dataset_val = sampler.DiMPSampler([my_dataset_val], [1], samples_per_epoch=settings.val_samples_per_epoch,
