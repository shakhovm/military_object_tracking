...
def parameters():
    ...
    net_path = f"{os.getcwd()}/experiments/checkpoints/ltr/bbreg/atom/ATOMnet_ep0050.pth.tar"
    # deep_feat = deep.ATOMResNet18(net_path='atom_default.pth', output_layers=['layer3'], fparams=deep_fparams,
    #                               normalize_power=2)
    deep_feat = deep.ATOMResNet18(net_path=net_path, output_layers=['layer3'], fparams=deep_fparams,
                                  normalize_power=2)
